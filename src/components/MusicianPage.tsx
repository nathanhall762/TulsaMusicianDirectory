...
const MusicianPage: React.FC<MusicianPageProps> = ({ musician }) => {
    const { bandcamp, facebook, genre, instagram, name, profileImage, spotify, spotifyID } = musician;
        ...
        <>
            <div className={styles.musicianPage}>
                <div className={styles.pageHeader}>
                    ...
                    <iframe className={styles.smallSpotifyPlayer} src={spotifyEmbed} width="100%" height="152" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
